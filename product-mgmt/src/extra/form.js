                ...
                <div className="container modal-body">
                    ...
                    <form>
                        <div className="form-group">
                            <input className="form-control" type="text" placeholder="First Name" value={this.state.fnm} onChange={this.handlefnmChange}/>
                        </div>
                        <div className="form-group">
                            <input className="form-control" type="text" placeholder="Last Name" value={this.state.lnm} onChange={this.handlelnmChange}/>
                        </div>
                        <div className="form-group">
